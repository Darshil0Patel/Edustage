		...
		<div class="page-wrapper">
						...
						<form action="AdminController" method="post">
							<div class="form-group input-group">
								...
								<input name="fname" class="form-control"
									placeholder="First name" type="text" autocomplete="off"
									required>
							</div>
							<div class="form-group input-group">
								<div class="input-group-prepend">
							...
							<div class="form-group input-group">
								...
								<input name="uid" class="form-control" placeholder="Unique ID"
									type="text" autocomplete="off" required>
							</div>
							<!-- form-group// -->
							<div class="form-group input-group">
		    ...
		    <option value="3">+701</option>
								...
								<input name="contact" class="form-control"
									placeholder="Phone number" type="number" autocomplete="off"
									required>
							</div>
							<!-- form-group// -->
							<div class="form-group input-group">
							...
							<div class="text-center">
								<button name="action" value="instructorregister"
