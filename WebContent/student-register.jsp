...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group input-group">
        ...
        <input name="erno" class="form-control" placeholder="Enrollment No" type="text" autocomplete="off" required>
    </div>
     <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
	...
	<div class="form-group input-group">
		...
		<select class="form-control" name="year">
			<option class="hidden" selected disabled> Select Current Year</option>
    ...
    <p class="text-center">Have an account? <a href="student-login.jsp">Log In</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
