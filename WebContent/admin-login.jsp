...
<article class="card-body mx-auto" style="max-width: 400px;">
	<h4 class="card-title mt-3 text-center " style="font-size: 30px;">Admin Login</h4>
	<form action="AdminController" method="post">
	<div class="form-group input-group">
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
        <input name="name" class="form-control" placeholder="Username" type="text" autocomplete="off">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
        <div class="input-group-prepend">
    ...
    <!-- <p class="text-center" style="font-size: 16px; color:#7b838a;line-height: 25px;">Don't have an account? <a href="register-index.jsp">Register</a> </p> -->                                                                 
</form>
<br><br><br><br><br>
</article>
</div> <!-- card.// -->
