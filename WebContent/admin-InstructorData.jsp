...
<body class="fix-header card-no-border fix-sidebar">
	...
	<%
	List<InstructorData> list = AdminDao.GetInstructors();
	AdminData a3 = null;
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">Instructor Data</h3>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
							<li class="breadcrumb-item active">Instructor Data</li>
						</ol>
					</div>
				...
				<div class="row">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Instructor Data</h4>
										...
										<tbody>
											<tr>
												...
												<form action="AdminController" method="post">
													...
													<input type="hidden" name="uid" value=<%=s.getUid()%>>
													...
													<input type="hidden" name="subject"
														value=<%=s.getSubject()%>> <input type="hidden"
														name="password" value=<%=s.getPassword()%>>
													<td><a
														href="admin-InstructorUpdate.jsp?id=<%=s.getId()%>"
														class="btn btn-success btn-sm"> Update </a>
													<td>
														<button name="action" value="deleteinstructor"
