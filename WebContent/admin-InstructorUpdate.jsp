...
<body class="fix-header card-no-border fix-sidebar">
	...
	%>
	<%
	InstructorData ind = AdminDao.GetInstructorsById(id);
	%>
	<!-- ============================================================== -->
	...
	<div id="main-wrapper">
		...
		<div class="page-wrapper">
					...
					<article class="card-body mx-auto" style="max-width: 400px;">
						...
						<form action="AdminController" method="post">
							<div class="form-group input-group">
								...
								<input name="uid" value=<%=ind.getUid()%> class="form-control"
									placeholder="Unique ID" type="text" autocomplete="off"
							...
							<div class="form-group input-group">
								...
								<input name="fname" value=<%=ind.getFname()%>
							...
							<div class="form-group input-group">
								...
								<input name="lname" value=<%=ind.getLname()%>
							...
							<div class="form-group input-group">
								...
								<input name="email" value=<%=ind.getEmail()%>
		    ...
		    <option value="3">+701</option>
								...
								<input name="contact" value=<%=ind.getContact()%>
							...
							<div class="form-group input-group">
								...
								<input name="password" value="<%=ind.getPassword()%>"
							...
							<div class="form-group">
								<input type="hidden" name="id" class="form-control"
									...
									name="contact" class="form-control" value=<%=ind.getContact()%> />
								<input type="hidden" name="email" class="form-control"
									value=<%=ind.getEmail()%> /> <input type="hidden"
									name="college" class="form-control" value=<%=ind.getCollege()%> />
								<input type="hidden" name="subject" class="form-control"
									value=<%=ind.getSubject()%> /> <input type="hidden" name="uid"
									class="form-control" value=<%=ind.getUid()%> /> <input
									type="hidden" name="year" class="form-control"
									value=<%=ind.getYear()%> />
								<div class="text-center">
									<button name="action" value="updateinstructor"
