<%@page import="com.bean.FilesData"%>
...
%>
<%
	List<FilesData> list = StudentDao.GetAdaNotes(sd);
%>
    ...
    <tbody>
      <tr>
        ...
        <input type="hidden" name="filename" value=<%=f.getFilename() %>>
      	<input type="hidden" name="path" value=<%=f.getPath() %>>
        <td><button type="submit" class="btn btn-primary" name="action" value="download">Download</button></td>
      	</form>
      </tr>
    </tbody>
    <%} %>
