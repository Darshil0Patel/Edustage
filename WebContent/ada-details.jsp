...
<br>
	...
	<h2 style="text-align: center; color: #002347;">Analysis and Design of Algorithms</h2>

<div class="content_wrapper">
<h4 class="title">Objectives</h4>
<div class="content">
The educational Objectives of this Course are: <br>
1) To Introduce various designing techniques and methods for algorithms<br> 
2) Performance analysis of Algorithms using asymptotic and empirical approaches<br> 
3) Demonstrate a familiarity with major algorithms and data structures.<br> 
4) To give clear idea on algorithmic design paradigms like Divide-and-Conquer,
Dynamic Programming, Greedy, Branch and Bound etc.
<br>
<br>
Upon completion of this course, students will be able to do the following:
<br>
1) Analyze the asymptotic performance of algorithms.<br>
2) Write rigorous correctness proofs for algorithms.<br>
3) Demonstrate a familiarity with major algorithms and data structures.<br>
4) Apply important algorithmic design paradigms and methods of analysis.<br>
5) Synthesize efficient algorithms in common engineering design situations.<br>
</div>
...
<p>Fundamentals of Algorithms & Mathematics</p>
</li>
<li class="justify-content-between d-flex">
...
<li class="justify-content-between d-flex">
<p>Introduction to Complexity Theory</p>
</li>
<li class="justify-content-center mx-sm-3 ">
<a style="text-decoration: none;" class="primary-btn text-uppercase " href="ada-lec.jsp">View Lectures</a>
<a style="text-decoration: none;" class="primary-btn text-uppercase " href="ada-notes.jsp">View Notes</a>
</li>
</ul>
</div>
</div>
...
<a href="#" style="text-decoration: none;" class="primary-btn2 text-right">Submit</a>
</div>
</div>
