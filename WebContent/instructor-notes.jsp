...
<h2 class="mb-3">
<%
	if(ind.getSubject().equals("CN"))
	{
		out.print("Upload Computer Network Notes");
	} 
	else if(ind.getSubject().equals("ADA"))
	{
		out.print("Upload Analysis and Design of Algorithms Notes");
	}
	else if(ind.getSubject().equals("SE"))
	{
		out.print("Upload Software Engineering Notes");
	}
...
<div class="desc">
<h4 class="mt-3 mb-2">Upload Here</h4>
<form action="UploadController" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleFormControlFile1">Example : Notes_XYZ</label>
    <input type="text" class="form-control-file" name="name" placeholder="Enter name of file without space" required autocomplete="off"><br>
    <input type="file" class="form-control-file" name="filename" id="exampleFormControlFile1" multiple required>
  </div>
  <div class="form-group">
  	<input type="hidden" name="year" value=<%=ind.getYear() %>>
  	<input type="hidden" name="college" value=<%=ind.getCollege() %>>
  	<input type="hidden" name="subject" value=<%=ind.getSubject() %>>
  	<input type="hidden" name="id" value=<%=ind.getId() %>>
    <input type="submit" name="action" value="Upload" style="width:40%" class="btn btn-primary" >
  </div>
</form>
</div>
</div>
...
<script defer src="../../../static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"6ab88397f0f96e9e","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.10.0","si":100}'></script>
<script defer src="../../../static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"6ab88397efba6e9e","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.10.0","si":100}'></script>
</body>
