...
%>
<%
	List<AttendanceData> list = AttendanceDao.ListOfStudent(sd.getId());
%>
			...
			<table class="table table-bordered text-center">
				...
				<tbody style="font-size:18px;">
					<tr>
						...
						<td><%=a.getErno()%></td>
						<td><%=a.getSubject() %></td>
						<td style="color: green; font-weight: bold;"><%=a.getPresent().toUpperCase() %></td>
						<td style="color: red; font-weight: bold;"><%=a.getAbsent().toUpperCase() %></td>
					</tr>
				</tbody>
				<%
					}
