...
<li class="nav-item">
<a class="nav-link"><%="Welcome, "+sd.getFname()%></a>
</li>
</ul>
</div>
</div>
...
<h4 class="mb-3">
<a href="cn-details.jsp" style="text-decoration: none;">Computer Network</a>
</h4>
<p>
...
<span class="tag mb-4 d-inline-block">subject</span>
<h4 class="mb-3">
<a href="ada-details.jsp" style="text-decoration: none;">Analysis and Design of Algorithm</a>
</h4>
<p>
...
<span class="tag mb-4 d-inline-block">subject</span>
<h4 class="mb-3">
<a href="se-details.jsp" style="text-decoration: none;">Software Engineering</a>
</h4>
<p>
One make creepeth man bearing their one firmament won't fowl
meat over sea
