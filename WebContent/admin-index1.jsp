        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="admin-index1.jsp">
                        <!-- Logo icon --><b>
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#"
                                id="navbarDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    ...
                                    class="hidden-md-down"><%=a3.getName().toUpperCase() %> &nbsp;</span> </a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="table-responsive mt-3 no-wrap">
                                    <table class="table vm no-th-brd pro-of-month">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="admin/assets/images/users/2.jpg"
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="up-img" style="background-image:url(admin/assets/images/big/img1.jpg)"></div>
                            <div class="card-body">
