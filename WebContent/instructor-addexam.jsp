			...
			<form class="text-center" action="ExamController" method="post"
				...
				<div class="form-group" style="padding-bottom: 15px;">
					<a class="btn btn-outline-success" style="text-decoration: none;"
						href="instructor-showexam.jsp"> Show All Questions </a>
					<a class="btn btn-outline-success" style="text-decoration: none;"
						href="instructor-showexamdetail.jsp"> Show Details </a>
				</div>
				...
				<div class="form-group">
					<label for="exampleInputEmail1">Enter Question</label> <input
						type="text" name="question" class="form-control"
						id="exampleInputEmail1" aria-describedby="emailHelp"
						placeholder="Enter Question" required autocomplete="off">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Option 1</label> <input type="text"
						name="option1" class="form-control" id="exampleInputEmail1"
						aria-describedby="emailHelp" placeholder="Enter Option 1" required
						autocomplete="off">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Option 2</label> <input type="text"
						name="option2" class="form-control" id="exampleInputEmail1"
						aria-describedby="emailHelp" placeholder="Enter Option 2" required
						autocomplete="off">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Option 3</label> <input type="text"
						name="option3" class="form-control" id="exampleInputEmail1"
						aria-describedby="emailHelp" placeholder="Enter Option 3" required
						autocomplete="off">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Option 4</label> <input type="text"
						name="option4" class="form-control" id="exampleInputEmail1"
						aria-describedby="emailHelp" placeholder="Enter Option 4"
						required autocomplete="off">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Positive Marks</label> <input
						type="text" name="positivemarks" class="form-control"
						id="exampleInputEmail1" aria-describedby="emailHelp"
						placeholder="Enter Marks" required autocomplete="off">
				</div>
				<div class="form-group">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="examtype"
						id="inlineRadio1" value="classtest" required="required"> <label
						...
						id="inlineRadio1" value="midexam"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">Mid-Term</label> <input
						class="form-check-input" type="radio" name="examtype"
						id="inlineRadio1" value="remedial"> <label
						class="form-check-label" for="inlineRadio1"
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="negativemarks"
						id="inlineRadio1" value="minus1point5" required="required">
					<label class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">-1.5</label> <input
						class="form-check-input" type="radio" name="negativemarks"
						id="inlineRadio1" value="minus1"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">-1</label> <input
						class="form-check-input" type="radio" name="negativemarks"
						id="inlineRadio1" value="minuspoint5"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">-0.5</label> <input
						class="form-check-input" type="radio" name="negativemarks"
						id="inlineRadio1" value="zero"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">0</label>
				</div>
				<br> <br>
				<div class="form-group">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="correct"
						id="inlineRadio1" value="option1" required="required"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">Option 1</label> <input
						class="form-check-input" type="radio" name="correct"
						id="inlineRadio1" value="option2"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">Option 2</label> <input
						class="form-check-input" type="radio" name="correct"
						id="inlineRadio1" value="option3"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">Option 3</label> <input
						class="form-check-input" type="radio" name="correct"
						id="inlineRadio1" value="option4"> <label
						class="form-check-label" for="inlineRadio1"
						style="margin-right: 20px;">Option 4</label>
				</div>
				<br> <br> <input type="hidden" name="college"
					value=<%=ind.getCollege()%>> <input type="hidden"
					name="year" value=<%=ind.getYear()%>> <input type="hidden"
					name="subject" value=<%=ind.getSubject()%>>
				<button type="submit" class="btn btn-primary" name="action"
					value="AddQuestion">Add Question</button>
			</form>
