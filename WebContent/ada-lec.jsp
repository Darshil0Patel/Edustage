...
<%@page import="com.bean.VideoData"%>
...
<body>
	...
	%>
	<%
	List<VideoData> list = StudentDao.GetAdaVideos(sd);
	%>
					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link"
								href="courses.jsp">Learnings</a></li>
...
<a class="primary-btn text-uppercase " href="cn-lec.jsp">View Lectures</a>
<a class="primary-btn text-uppercase " href="#">View Notes</a>
</li>
</ul>
</div>
</div>
...
Replenish man have thing gathering lights yielding shall you
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-3">
					<%-- <embed src="<%=vd.getVideo().replace("https://youtu.be/","https://youtube.com/embed/") %>"> --%>
					<iframe width="350" height="250"
						src="<%=vd.getVideo().replace("https://youtu.be/", "https://youtube.com/embed/")%>"
	...
	<script defer
		...
		data-cf-beacon='{"rayId":"6ab8839a10f0d5fc","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.10.0","si":100}'></script>
	<script defer
		src="../../../static.cloudflareinsights.com/beacon.min.js"
		data-cf-beacon='{"rayId":"6ab8839a0a76d5fc","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.10.0","si":100}'></script>
</body>
