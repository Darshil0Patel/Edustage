...
<body>
	...
	%>
	<%
	List<StudentData> list = InstructorDao.StudentData1(ind);
	%>
			...
			<div class="row justify-content-center">
				<div>
					<div class="" style="padding-bottom: 30px;">
						<a class="btn btn-primary" href="instructor-ViewAttendance.jsp">View
							Attendance</a>
					</div>
				</div>
			</div>
				...
				<tbody style="font-size: 18px;">
					<tr>
						...
						<form action="AttendanceController" method="post">
							<input type="hidden" name="sid" value=<%=s.getId()%>> <input
								...
								type="hidden" name="contact" value=<%=s.getContact()%>>
							<input type="hidden" name="college" value=<%=s.getCollege()%>>
							<input type="hidden" name="year" value=<%=s.getYear()%>>
							...
							<td><input name="action" type="submit"
								class="btn btn-success" value="Present"></td>
							<td><input name="action" type="submit"
								class="btn btn-danger" value="Absent"></td>
						</form>
					</tr>
				</tbody>
				<%
